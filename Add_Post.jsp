...
if(msg!=null){
  if(msg.equalsIgnoreCase("success")){
     %>
     <font color="green">Successfully Posted <image src="images/success-mark-png-3.png" width="100" height="100"/></font> 
     
     <%
  }else{
%>
     <font color="red"><image src="images/fail.1c191ba8.png" width="100" height="100"/></font> 
     ...
     <%
            ...
            <table>
                   <tr>
                      <th>Post Name</th><td><input type="text" name="pname" required=""></td></tr>
                  <tr>  <th>Post Content</th><td><textarea cols="25" rows="8" name="pcontent"></textarea></td></tr>
                  <tr>  <th>Post Image</th><td><input type="file" name="image"></td></tr>
